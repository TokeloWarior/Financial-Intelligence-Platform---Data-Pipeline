...
CREATE INDEX idx_raw_accounts_ingestion_batch_id
    ON raw.raw_accounts (ingestion_batch_id);

CREATE INDEX idx_raw_accounts_source_account_id
    ON raw.raw_accounts (source_account_id);

CREATE INDEX idx_raw_accounts_source_customer_id
    ON raw.raw_accounts (source_customer_id);

CREATE INDEX idx_raw_accounts_customer_link_key
    ON raw.raw_accounts (customer_link_key);

CREATE INDEX idx_raw_accounts_account_number
    ON raw.raw_accounts (account_number);

CREATE INDEX idx_raw_accounts_validation_status
    ON raw.raw_accounts (validation_status);

CREATE INDEX idx_raw_accounts_created_at
    ON raw.raw_accounts (created_at);

CREATE UNIQUE INDEX uq_raw_accounts_source_account_id
    ON raw.raw_accounts (source_account_id);

CREATE UNIQUE INDEX uq_raw_accounts_customer_link_key
    ON raw.raw_accounts (customer_link_key);

CREATE UNIQUE INDEX uq_raw_accounts_account_number
    ON raw.raw_accounts (account_number);
...
CREATE INDEX idx_clean_accounts_customer_id
    ON clean.accounts (customer_id);

CREATE INDEX idx_clean_accounts_customer_profile_id
    ON clean.accounts (customer_profile_id);

CREATE INDEX idx_clean_accounts_source_customer_id
    ON clean.accounts (source_customer_id);

CREATE INDEX idx_clean_accounts_customer_link_key
    ON clean.accounts (customer_link_key);

CREATE INDEX idx_clean_accounts_account_status
    ON clean.accounts (account_status);

CREATE INDEX idx_clean_accounts_account_type
    ON clean.accounts (account_type);

CREATE INDEX idx_clean_accounts_last_seen_batch_id
    ON clean.accounts (last_seen_batch_id);
